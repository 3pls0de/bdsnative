        ...
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <form class="row g-3" method="POST" action="../action/action_add.php" enctype="multipart/form-data">
                <div class="col-12">
                  ...
                  <div class="col-12">
                    <select class="form-select" aria-label="Default select example" name="tipe_produk" required>
                      ...
                      foreach ($restype as $key => $value) {
                        echo '
                        <option value="' . $value['id_tipe'] . '">' . ucwords($value['nama_tipe']) . '</option>';
                      }
                       ?>
                    </select>
                  </div>
                ...
                <div class="col-12">
                  <div class="form-floating">
                    <input type="text" name="nama_produk" class="form-control " id="floatingnama_produk" placeholder="Nama Produk*" required  >
                ...
                <div class="col-12">
                  <div class="form-floating">
                    <textarea name="detail_komposisi" class="form-control" id="floatingdetail_komposisi" placeholder="Detail Produk" maxlength="150" style="height: 100px;"></textarea>
                ...
                <div class="col-12">
                  <div class="form-floating">
                    <input type="number" name="harga_produk" class="form-control" id="harga_produk" placeholder="Harga Produk*" required >
                ...
                <div class="col-12">
                  <div class="form-floating">
                    <input type="text" name="ukuran_kemasan" class="form-control" id="ukuran_kemasan" placeholder="Ukuran Kemasan*" required >
